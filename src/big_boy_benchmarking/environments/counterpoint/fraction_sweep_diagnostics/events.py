"""Flat rows for counterpoint contraction fraction sweep diagnostics."""
...
class FractionSweepEvaluationRunIndexRow(FlatRow):
    evaluation_id: str
    run_id: str
    instance_id: str
    arm_id: str
...
@dataclass(frozen=True)
class FractionSweepEpisodeRow(FlatRow):
    evaluation_id: str
    run_id: str
    instance_id: str
    arm_id: str
...
@dataclass(frozen=True)
class FractionSweepStepRow(FlatRow):
    evaluation_id: str
    run_id: str
    instance_id: str
    arm_id: str
...
@dataclass(frozen=True)
class FractionSweepControlEventRow(FlatRow):
    evaluation_id: str
    run_id: str
    instance_id: str
    arm_id: str
...
@dataclass(frozen=True)
class FractionSweepLiftFiberEventRow(FlatRow):
    evaluation_id: str
    run_id: str
    instance_id: str
    arm_id: str
...
@dataclass(frozen=True)
class FractionSweepABCSelectionEventRow(FlatRow):
    evaluation_id: str
    run_id: str
    instance_id: str
    arm_id: str
...
@dataclass(frozen=True)
class FractionSweepABCTierSignalEventRow(FlatRow):
    evaluation_id: str
    run_id: str
    instance_id: str
    arm_id: str
...
@dataclass(frozen=True)
class SchemaFractionSummaryRow(FlatRow):
    evaluation_id: str
    instance_id: str
    arm_id: str
    numerator: int
    ...
    scheduled_edges_per_state_minus_one: float | None
    source_count_with_scheduled_edges: int
    min_selected_edges_per_source: int | None
    mean_selected_edges_per_source: float | None
    max_selected_edges_per_source: int | None
    min_source_out_degree: int | None
    mean_source_out_degree: float | None
    max_source_out_degree: int | None
    quota_rule_id: str
...
@dataclass(frozen=True)
class FractionSweepTowerShapeSummaryRow(FlatRow):
    evaluation_id: str
    run_id: str
    instance_id: str
    arm_id: str
...
@dataclass(frozen=True)
class LegacyOneThirdEquivalenceSummaryRow(FlatRow):
    evaluation_id: str
    instance_id: str
    arm_id: str
    numerator: int
    ...
    schema_seed: int
    equivalent: bool
    fraction_edge_count: int
    legacy_edge_count: int
    missing_from_fraction_count: int
    extra_in_fraction_count: int
    missing_from_fraction_examples: str
    extra_in_fraction_examples: str


@dataclass(frozen=True)
class CollapseThresholdSummaryRow(FlatRow):
    evaluation_id: str
    instance_id: str
    schema_seed: int
    first_full_collapse_numerator: int | None
    first_near_collapse_numerator: int | None
    last_nontrivial_numerator: int | None
    n06_matches_legacy: bool | None
    sweep_verdict: str


@dataclass(frozen=True)
class FractionSweepAggregateTableRow(FlatRow):
    evaluation_id: str
    run_id: str
    instance_id: str
    arm_id: str
