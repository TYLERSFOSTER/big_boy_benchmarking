...
SEGMENT_CATEGORIES: dict[str, tuple[str, bool]] = {
    ...
    "linearization_report_build": ("linearization_setup", True),
    "encoding_registry_build": ("linearization_setup", True),
    "linearize_action_selection": ("conversion_online", True),
    "linearize_training_transition": ("conversion_online", True),
    "torch_decision_batch_build": ("conversion_online", True),
    "torch_transition_batch_build": ("conversion_online", True),
    "tensor_policy_forward": ("learner_online", True),
    "tensor_action_decode": ("learner_online", True),
